...
\begin{tabular}{lD{.}{.}{2}D{.}{.}{2}D{.}{.}{2}}\hline 
 & \multicolumn{1}{ l }{ Model 1 } & \multicolumn{1}{ l }{ Model 2 } & \multicolumn{1}{ l }{ Model 3 }\\ \hline
...
Majoritarian Presidential              &                  &                  & -10.36 ^{***}   \\ 
                                       &                  &                  & (2.70)          \\
Continents                             & \mathrm{No}     & \mathrm{Yes}    & \mathrm{Yes}   \\ 
Colonies                               & \mathrm{No}     & \mathrm{Yes}    & \mathrm{Yes}   \\ 
...
\multicolumn{ 4 }{l}{\footnotesize{ Data from Persson \& Tabellini (2003) }}
